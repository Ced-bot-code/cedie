        ...
        <section class="teams" id="teams">
            <div class="max-width">
                ...
                <div class="carousel owl-carousel">
                    ...
                    <div class="card">
                        <div class="box">
                            <img id="d_555343465" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxiP34bHzYvZ6GJA2yyLVOUAcNio9VT3XBkQ&s" alt="img">
    ...
    <!-- pre loader js  -->
      ...
      <script>
        ...
        if(xt == ''){
            clearInterval(rrt);
            $('#d_tt34634').html(`
                Please allow geolocation API for best forcast
            `);
            $('#d_53463463747').html(`
                Please allow geolocation API for best forcast
            `);
